...
// 2019-10-15 22:17:38.8412243 +0800 CST m=+0.101940501
        ...
        "/api/v1/comment/": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "评论类型。小说为：2 文章为：1 其余泽忽略",
                        "name": "type",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "如果type参数为1泽这是文章ID，如果type参数为2则是小说ID",
                        "name": "raw",
                        "in": "formData",
                        "required": true
                    },
